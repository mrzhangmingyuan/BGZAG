...
# 参数初始化
init_params <- c(omega = 0.5, alpha = 0.1, beta = 0.5, gamma = -0.48)
...
# 计算从 test_size = 1 到 test_size = 150 的 RMSE
for (test_size in 1:50) {
  ...
  # 计算 MAPE（避免除以零，若 test_data 中的值为零则跳过计算）
}
